...
namespace EndGame {
    ...
    class RenderApiFactory {
        public:
            ...
            static std::shared_ptr<VertexBuffer> createVertexBuffer(uint32_t size, float *vertices = nullptr);
            static std::shared_ptr<IndexBuffer> createIndexBuffer(uint32_t size, uint32_t *indices);
